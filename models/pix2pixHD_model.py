...
class Pix2PixHDModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG = self.get_G(
            netG_input_nc, opt.output_nc, n_blocks=9, opt=opt)
    ...
    def forward(self, label, pre_clothes_mask, img_fore, clothes_mask, clothes, all_clothes_label, real_image, pose, mask):
        ...
        return [self.loss_filter(loss_G_GAN, loss_G_GAN_Feat, loss_G_VGG, loss_D_real, loss_D_fake), fake_c, comp_fake_c, dis_label, L1_loss, style_loss, fake_cl, warped, clothes, CE_loss, rx*0.1, ry*0.1, cx*0.1, cy*0.1, rg*0.1, cg*0.1]
